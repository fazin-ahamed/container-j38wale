...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-j38wale.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-j38wale.containers.anotherwebservice.com/
...
```
git clone git@github.com:fazin-ahamed/container-j38wale.git
cd container-j38wale
```
...
```
docker attach container-j38wale
```
